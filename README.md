...
make verify        # the full 21-gate pipeline (CI parity)
...
|---|---|---|
| Quality & Metrics | ✅ | `make verify` (21 stages) = CI parity; in-process p95-latency guard is now merge-blocking (was previously claimed as a gate but wasn't wired — fixed 2026-07-05). ⚠️ Open: no `DEFINITION_OF_DONE.md`, no DORA ledger. |
