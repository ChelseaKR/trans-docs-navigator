...
- **2507 of 3070 prose sentences** in the corpus carry no extractable
...
- **967 sentences state a negative** (`you do not need a court order`, `the page no
...
**the source is application/pdf — this gate extracts text from HTML only, so nothing in it can be checked** — 292 assertion(s):
...
**the official form has no identifier to match on** — 68 assertion(s):
