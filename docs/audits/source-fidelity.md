...
|---|---|
| Records audited | 666 |
| Load-bearing assertions found | 1495 |
| — checked and **supported** by the cited source | 1009 |
| — checked and **UNSUPPORTED** (merge-blocking) | 0 |
| — **UNCHECKABLE** (reported, never passed) | 486 |
| of the checked: literal (fee / duration / form-id) matches | 681 |
| of the checked: necessary-condition only (topic present, wording NOT verified) | 328 |

## What this gate cannot vouch for

- **2479 of 3039 prose sentences** in the corpus carry no extractable
...
- **962 sentences state a negative** (`you do not need a court order`, `the page no
...
- **328 assertions are necessary-condition only**: the source discusses the topic, which
...
**the official form has no identifier to match on** — 72 assertion(s):
