...
|---|---|
| Records audited | 174 |
| Load-bearing assertions found | 489 |
| — checked and **supported** by the cited source | 375 |
...
- **664 of 832 prose sentences** in the corpus carry no extractable
...
- **218 sentences state a negative** (`you do not need a court order`, `the page no
