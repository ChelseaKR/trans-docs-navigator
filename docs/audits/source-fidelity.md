...
- **688 of 860 prose sentences** in the corpus carry no extractable
...
**the source is application/pdf — this gate extracts text from HTML only, so nothing in it can be checked** — 34 assertion(s):
