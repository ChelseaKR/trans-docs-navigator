...
- **2489 of 3053 prose sentences** in the corpus carry no extractable
...
- **968 sentences state a negative** (`you do not need a court order`, `the page no
...
**the official form has no identifier to match on** — 76 assertion(s):
