...
|---|---|
| Records audited | 80 |
| Load-bearing assertions found | 194 |
| — checked and **supported** by the cited source | 162 |
| — checked and **UNSUPPORTED** (merge-blocking) | 0 |
| — **UNCHECKABLE** (reported, never passed) | 32 |
| of the checked: literal (fee / duration / form-id) matches | 107 |
| of the checked: necessary-condition only (topic present, wording NOT verified) | 55 |

## What this gate cannot vouch for

- **293 of 366 prose sentences** in the corpus carry no extractable
...
- **88 sentences state a negative** (`you do not need a court order`, `the page no
...
- **55 assertions are necessary-condition only**: the source discusses the topic, which
