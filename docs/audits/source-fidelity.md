...
|---|---|
| Records audited | 290 |
| Load-bearing assertions found | 725 |
| — checked and **supported** by the cited source | 546 |
| — checked and **UNSUPPORTED** (merge-blocking) | 0 |
| — **UNCHECKABLE** (reported, never passed) | 179 |
| of the checked: literal (fee / duration / form-id) matches | 362 |
| of the checked: necessary-condition only (topic present, wording NOT verified) | 184 |

## What this gate cannot vouch for

- **1155 of 1424 prose sentences** in the corpus carry no extractable
...
- **411 sentences state a negative** (`you do not need a court order`, `the page no
