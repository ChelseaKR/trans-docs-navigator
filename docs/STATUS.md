...
|---|---|---|---|
| Named-human verification of every record | 🔴 **OPEN** | **0 of 804** records verified by a named human. 804 carry the `Pilot Seed Reviewer` placeholder. | `corpus/` + `forms/registry.json` × `corpus/VERIFIERS.json` |
