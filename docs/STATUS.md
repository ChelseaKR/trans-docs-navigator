...
|---|---|---|---|
| Named-human verification of every record | 🔴 **OPEN** | **0 of 1000** records verified by a named human. 1000 carry the `Pilot Seed Reviewer` placeholder. | `corpus/` + `forms/registry.json` × `corpus/VERIFIERS.json` |
